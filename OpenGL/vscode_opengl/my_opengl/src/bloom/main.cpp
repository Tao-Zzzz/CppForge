...
int main()
{
    ...
    // -------------------------
    Shader shader(
        FileSystem::getPath("src/bloom/bloom.vs").c_str(),
        FileSystem::getPath("src/bloom/bloom.fs").c_str());

    Shader shaderLight(
        FileSystem::getPath("src/bloom/bloom.vs").c_str(),
        FileSystem::getPath("src/bloom/light_box.fs").c_str());
    Shader shaderBlur(
        FileSystem::getPath("src/bloom/blur.vs").c_str(),
        FileSystem::getPath("src/bloom/blur.fs").c_str());

    Shader shaderBloomFinal(
        FileSystem::getPath("src/bloom/bloom_final.vs").c_str(),
        FileSystem::getPath("src/bloom/bloom_final.fs").c_str());
